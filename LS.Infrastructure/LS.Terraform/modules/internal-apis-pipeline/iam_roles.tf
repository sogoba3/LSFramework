### codebuild role
resource "aws_iam_role" "ls_framework_internal_services_codebuild_role" {
...
resource "aws_iam_role_policy" "codebuild_policy" {
  ...
  role = aws_iam_role.ls_framework_internal_services_codebuild_role.id
...
resource "aws_iam_role" "ls_framework_internal_services_codepipeline_role" {
...
resource "aws_iam_role_policy" "ls_framework_codepipeline_policy" {
  role = aws_iam_role.ls_framework_internal_services_codepipeline_role.id
